...
CREATE TABLE ESTATUS_FALTA(
    ...
    CONSTRAINT ESTATUS_FALTA_PK PRIMARY KEY (ESTATUS_FALTA_ID)
    USING INDEX (
...
CREATE TABLE FALTA_CIVIL(
    ...
    CLIENTE           NUMBER(38, 0)    NOT NULL,
    NUMERO_FALTA      NUMBER(38, 0)    NOT NULL,
    ...
    REFERENCES admin_ciudadanos.AUTO(AUTO_ID),
...
CREATE TABLE VELOCIDAD(
    FALTA_CIVIL_ID         NUMBER(10, 0)    NOT NULL,
    LATITUD                NUMBER(38, 6)    NOT NULL,
    LONGITUD               NUMBER(38, 6)    NOT NULL,
