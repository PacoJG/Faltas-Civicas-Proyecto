...
--@Fecha:   01/02/2021
--@Descripcion: Creacion de las tablas del modulo CIUDADANOS
...
-- 
-- TABLE: CIUDADANO (MODULO CIUDADANOS)
--
...
-- 
-- TABLE: CIUDADANO_TELEFONO (MODULO CIUDADANOS)
--
...
-- 
-- TABLE: DATOS_BIOMETRICOS (MODULO CIUDADANOS)
--
...
LOB (FOTO,FIRMA,HUELLA,HUELLA_2,HUELLA_3,HUELLA_4,HUELLA_5,HUELLA_6,HUELLA_7,HUELLA_8,HUELLA_9,HUELLA_10) STORE AS SECUREFILE (TABLESPACE COMUN_BLOB);

-- 
-- TABLE: HISTPRICO_AUTO (MODULO CIUDADANOS)
--
...
-- 
-- TABLE: TIPO_TRABAJO_COMUNITARIO (MODULO CIUDADANOS)
--
...
-- 
-- TABLE: TRABAJO_COMUNITARIO (MODULO CIUDADANOS)
--
